    ...
    return (
        <section id="contact" className="py-24 bg-white">
            <div className="container mx-auto px-6 md:px-12 lg:px-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start max-w-6xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                    
                    {/* Left Column */}
                    <div className="space-y-8">
                        <ContactInfoItem icon={<GlobeIcon />}>
                            <a href="mailto:maheshm.fsd@gmail.com" className="text-lg text-blue-500 hover:underline">
                                maheshm.fsd@gmail.com
                            </a>
                        </ContactInfoItem>
                        <ContactInfoItem icon={<MapIcon />}>
                            <p className="text-lg text-secondary">
                                2/67A , South Street<br />
                                Sillupanur(po), Ariyalur, Pin: 621730
                            </p>
                        </ContactInfoItem>
                        <ContactInfoItem icon={<PhoneIcon />}>
                            <a href="tel:+917397015624" className="text-lg text-blue-500 hover:underline">
                                +91 7397015624
                            </a>
                        </ContactInfoItem>
                    </div>
